...
<section id = "header" >
   ...
   <section id="page-header">
    <div class="slider">
        <div class="slider-images">
          <img src="photos/img.jpg.png" alt="Image 1">
   ...
   <section id="about-head" class="sectionp1">
    <div id="who">
        <h1>ABOUT US</h1>
        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sapiente quo voluptate facilis eius odio unde veritatis aut iusto iure eligendi earum, perspiciatis velit accusamus at corrupti laudantium ratione vitae ullam! Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consequuntur cupiditate asperiores sint, quo, aspernatur sapiente modi quia suscipit tempora harum, incidunt similique? Minus rem neque culpa doloremque deserunt, voluptates earum. Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum exercitationem iusto itaque eius ducimus quibusdam ipsum totam ratione iste! Maiores incidunt ducimus eaque labore consequuntur repellendus ratione expedita vitae impedit. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Commodi eligendi enim quam eum ducimus numquam labore quae, possimus modi repellat autem sunt sapiente aut suscipit, deserunt, ipsam consequuntur officia alias.</p>
        <abbr title="">we make our items with perfection and love to have your feedback. For any furthur queries you can directly contact us on our emial or contact number</abbr>
        <br><br>
        <marquee  loop = "-1" scrollamount ="5" width="100%" >we love all your support, Contact: abc@gmail.com</marquee>
